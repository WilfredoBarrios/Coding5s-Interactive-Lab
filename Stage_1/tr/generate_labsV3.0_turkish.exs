...
defmodule LabGenerator do
  ...
  EEx.function_from_string(
    ...
    Bu, mentor istemidir (prompt). Bunu kodunuz ve kısa bir mantık açıklamasıyla birlikte (hepsi tek bir mesajda) yapay zeka asistanınıza kopyalayıp yapıştırın. Hataları ayıklamak, kodunuzu profesyonelleştirmek, yeni bir zorluk talep etmek veya daha derin bir açıklama almak için kullanın. Ayrıca mentora özel sorular sorabilir veya becerilerinizi test etmek için yeni zorluklar isteyebilirsiniz. Bu seçkin mentor simülatörü, mühendislik sezginizi keskinleştirmek için üst düzey geri bildirim sağlar.
    ...
    ### 💻 Live Execution
    Kalıcı kas hafızası oluşturmak ve her örneği manuel olarak yazmak için aşağıdaki Elixir yürütme hücresini kullanın. 💡 Profesyonel İpucu: Herhangi bir bölümün altındaki + Elixir düğmesine tıklayarak daha fazla yürütme hücresi ekleyebilirsiniz.
...
LabGenerator.run("elixir_curriculum_turkish.csv")
