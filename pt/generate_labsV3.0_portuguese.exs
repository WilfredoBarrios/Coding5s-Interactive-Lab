...
defmodule LabGenerator do
  ...
  EEx.function_from_string(
    ...
    A IA fornecerá de 3 a 5 exemplos práticos. Para desenvolver uma memória muscular duradoura, digite cada exemplo manualmente na célula abaixo. Analise as analogias fornecidas e leia os comentários internos com atenção—eles contêm a lógica arquitetônica que você precisa para dominar este tópico. Basta copiar e colar o seguinte no seu chat de IA e enviar.
    ...
    ### 💻 Live Execution
    Use a célula de execução do Elixir abaixo para digitar manualmente cada exemplo e desenvolver uma memória muscular duradoura. 💡 Pro Tip: Você pode adicionar mais células de execução clicando no botão + Elixir na parte inferior de qualquer seção.
...
LabGenerator.run("elixir_curriculum_portuguese.csv")
